...
const FriendProfile = ({ route, navigation }) => {
    ...
    const friendProfileXml =
        profileIcons[friend?.profile] || profileIcons["01"]; // Fallback to "01" if profile not found
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footerContainer}>
                <Text style={styles.footerText}>
                    Member since:{" "}
                    <Text style={styles.boldPinkText}>{formattedDate}</Text>
                </Text>
            </View>
        </View>
    );
