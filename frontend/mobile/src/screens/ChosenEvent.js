...
const ChosenEvent = () => {
    ...
    const getSelectedSlotKeys = (start, end) => {
        ...
        const endPos = allSlotEntries.findIndex(
            (item) => item.key === endTimeStr
        );
                ...
                <View style={styles.container}>
                    ...
                    >
                        ...
                        <View style={styles.numberInputContainer}>
                            <TouchableOpacity
                                onPress={() =>
                                    setNumPlayers(Math.max(1, numPlayers - 1))
                                }
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    ...
                                    setNumPlayers(
                                        Math.min(numPlayers + 1, maxCapacity)
                                    );
                                }}
                                style={styles.numberButton}
                            >
