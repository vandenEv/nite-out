      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.descriptionWrapper}>
          <Text style={styles.descriptionText}>
            This pub has a green leaf icon because it has a low BER rating
            (A1–B2), indicating high energy efficiency. We highlight these pubs
            as more sustainable and environmentally friendly choices for your
            night out.
          </Text>
        </View>
      </View>
