...
def test_fail_wrong_host():
    ...
    """
    game = Game("Alice", "Poker Night", "A fun poker game.", "Card Game", "18:00", "21:00", "23:00", "Pub A", 10.0, 20.0, 5)
...
def test_fail_add_participant():
    ...
    """
    game = Game("Alice", "Poker Night", "A fun poker game.", "Card Game", "18:00", "21:00", "23:00", "Pub A", 10.0, 20.0, 1)
    result = game.add_participant("Charlie")
    expected_message = "Charlie joined the game."  # Intentionally incorrect
...
def test_fail_seat_already_taken():
    ...
    """
    seat_game = SeatBasedGame("Alice", "Chess Tournament", "A fun chess game.", "Board Game", "17:00", "19:00", "23:59", "Pub B", 10.5, 20.5, 4)
...
def test_fail_reserve_table_wrong_message():
    ...
    """
    table_game = TableBasedGame("Alice", "D&D Night", "A fun ropleplaying event.", "Roleplaying", "19:00", "22:00", "23:59", "Pub C", 10.2, 21.8, 6, ["Table 1", "Table 2"])
